...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems := []model.SettingItem{
		...
		// style settings
		{Key: conf.Logo, Value: "/static/logo.png", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "/static/favicon.ico", Type: conf.TypeString, Group: model.STYLE},
		...
		{Key: conf.ImageTypes, Value: "jpg,tiff,jpeg,png,gif,bmp,svg,ico,swf,webp,avif,heic", Type: conf.TypeText, Group: model.PREVIEW, Flag: model.PRIVATE},
